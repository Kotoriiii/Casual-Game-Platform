...
public class ChessPanel {
	...
	public static void drawInitialChess(Group root) throws FileNotFoundException {
//		ChessPanel chessPanel = new ChessPanel();
		...
		for (int i = 0; i < imgs.length; i++) {
			switch (i) {
			case 1:
				imgs[i] = new Image(new FileInputStream("img/b_c.png"));
				break;
			case 2:
				imgs[i] = new Image(new FileInputStream("img/b_m.png"));
				break;
			case 3:
				imgs[i] = new Image(new FileInputStream("img/b_x.png"));
				break;
			case 4:
				imgs[i] = new Image(new FileInputStream("img/b_s.png"));
				break;
			case 5:
				imgs[i] = new Image(new FileInputStream("img/b_j.png"));
				break;
			case 6:
				imgs[i] = new Image(new FileInputStream("img/b_p.png"));
				break;
			case 7:
				imgs[i] = new Image(new FileInputStream("img/b_z.png"));
				break;

			case 11:
				imgs[i] = new Image(new FileInputStream("img/r_c.png"));
				break;
			case 12:
				imgs[i] = new Image(new FileInputStream("img/r_m.png"));
				break;
			case 13:
				imgs[i] = new Image(new FileInputStream("img/r_x.png"));
				break;
			case 14:
				imgs[i] = new Image(new FileInputStream("img/r_s.png"));
				break;
			case 15:
				imgs[i] = new Image(new FileInputStream("img/r_j.png"));
				break;
			case 16:
				imgs[i] = new Image(new FileInputStream("img/r_p.png"));
				break;
			case 17:
				imgs[i] = new Image(new FileInputStream("img/r_z.png"));
//				imageViews[i] = new ImageView(imgs[i]);
				break;
			}
		}
	...
	public static void drawChessPanel(GraphicsContext gc) {
